...
"[project]/src/app/dashboards/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewDashboardPage() {
    ...
    async function handleCreate() {
        ...
        try {
            ...
            if (data.id) router.push(`/dashboards/${data.id}`);
        } finally{
            setCreating(false);
        }
    }
...
//# sourceMappingURL=src_4af4dde4._.js.map