...
function OnboardingGuard({ children }) {
    ...
    const completed = "undefined" !== "undefined" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2d$completed$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOnboardingCompleted"])();
...
function fetchBackground() {
    return fetch("/api/dashboard").then((r)=>r.json()).then((d)=>d?.background ?? null).catch(()=>null);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19f02086._.js.map