...
"[project]/src/components/widgets/card-icons.tsx [app-ssr] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.resolve().then(() => {
        return parentImport("[project]/src/components/widgets/card-icons.tsx [app-ssr] (ecmascript)");
    });
});
}),
];