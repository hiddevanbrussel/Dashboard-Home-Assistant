                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            mediaImageSrc ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "relative w-full aspect-square max-h-48 mx-auto rounded-xl overflow-hidden bg-white/5",
...
function ClimateCard2Widget({ title = "Air Conditioner", entity_id, size = "md", className, onMoreClick }) {
    ...
    const minTemp = Number(entity?.attributes?.min_temp) || TEMP_MIN;
    const maxTemp = Number(entity?.attributes?.max_temp) || TEMP_MAX;
    const tempStep = Number(entity?.attributes?.target_temp_step) || 1;
    const hvacModes = entity?.attributes?.hvac_modes ?? [];
    const state = entity?.state ?? "";
    const hvacModeFromAttr = entity?.attributes?.hvac_mode;
    const stateToMode = {
    ...
    const tempOptions = Array.from({
        length: Math.round((maxTemp - minTemp) / tempStep) + 1
    }, (_, i)=>minTemp + i * tempStep);
    async function setTemperature(temperature) {
        const clamped = Math.min(maxTemp, Math.max(minTemp, Math.round(temperature)));
        setLoading(true);
        try {
            const res = await fetch("/api/ha/call-service", {
                method: "POST",
...
function WidgetByType({ type, title, entity_id, consumption_entity_id, show_icon, size }) {
...
function DashboardEditPage() {
    ...
    const layoutForGrid = layout.filter((item)=>{
        const type = widgets.find((w)=>w.id === item.i)?.type;
        return type !== "media_card" && type !== "climate_card" && type !== "climate_card_2" && type !== "solar_card" && type !== "weather_card";
    });
    ...
    function handleAddTile(type, entityId) {
        ...
        const newLayout = type === "solar_card" || type === "weather_card" || type === "climate_card" || type === "climate_card_2" ? layout : [
            ...layout,
            newLayoutItem
        ];
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: widgets.filter((w)=>w.type !== "media_card" && w.type !== "climate_card" && w.type !== "climate_card_2" && w.type !== "solar_card" && w.type !== "weather_card").map((w)=>{
...
//# sourceMappingURL=src_cda07a7b._.js.map