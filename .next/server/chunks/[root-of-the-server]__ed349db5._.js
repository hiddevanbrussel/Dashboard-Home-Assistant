module.exports = [
"[project]/.next-internal/server/app/api/ha/media-image/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ha/media-image/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const imageUrl = picture.startsWith("http") ? picture : `${config.baseUrl.replace(/\/+$/, "")}${picture.startsWith("/") ? "" : "/"}${picture}`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ed349db5._.js.map