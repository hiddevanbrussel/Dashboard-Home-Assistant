module.exports = [
"[project]/.next-internal/server/app/api/ha/connection/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ha/connection/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const conn = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].connection.findFirst({
        orderBy: {
            createdAt: "desc"
        },
        select: {
    ...
    if (!conn) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        baseUrl: null
    });
...
async function POST(request) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].connection.deleteMany({});
        const encryptedToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$encrypt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encrypt"])(validated.data.token);
        const conn = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].connection.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d3c3cf8._.js.map