...
_s(FloatingLightCard, "1oGWX+dwaefk5UdcfWQRCkGsmYA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$entity$2d$state$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEntityStateStore"]
    ];
});
                        ...
                        children: hvacModes.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                            ...
                            children: hvacModes.map((mode)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: mode,
                                    children: (_stateLabel_mode = stateLabel[mode]) !== null && _stateLabel_mode !== void 0 ? _stateLabel_mode : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["capitalizeFirst"])(mode)
                                }, mode, false, {
                                    fileName: "[project]/src/components/widgets/climate-card-widget.tsx",
                                    lineNumber: 149,
                                    columnNumber: 17
...
function WidgetByType(param) {
    let { type, title, entity_id, consumption_entity_id, humidity_entity_id, show_icon, script_ids, script_names, cleaned_area_entity_id, icon, size, conditions } = param;
    _s();
    var _ref;
...
function DashboardEditPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardEditPage.useEffect": ()=>{
            if (editingWidget) {
                var _editingWidget_title, _editingWidget_entity_id, _editingWidget_consumption_entity_id, _editingWidget_humidity_entity_id, _editingWidget_script_ids, _editingWidget_script_names, _editingWidget_cleaned_area_entity_id, _editingWidget_icon, _editingWidget_size, _editingWidget_conditions;
                setEditForm({
    ...
    const onLayoutChange = (newLayout)=>{
        setLayout((prev)=>{
            const floatingItems = prev.filter((item)=>{
                ...
                return type === "media_card" || type === "climate_card" || type === "climate_card_2" || type === "title_card" || type === "pill_card";
            });
            return [
                ...newLayout,
                ...floatingItems
    ...
    const layoutForGrid = layout.filter((item)=>{
        var _widgets_find;
        const type = (_widgets_find = widgets.find((w)=>w.id === item.i)) === null || _widgets_find === void 0 ? void 0 : _widgets_find.type;
        return type !== "media_card" && type !== "climate_card" && type !== "climate_card_2" && type !== "light_card" && type !== "solar_card" && type !== "sensor_card" && type !== "weather_card" && type !== "vacuum_card" && type !== "title_card" && type !== "pill_card";
    });
    ...
    function handleAddTile(type, entityId, titleOverride) {
        ...
        const newLayout = type === "solar_card" || type === "sensor_card" || type === "weather_card" || type === "climate_card" || type === "climate_card_2" || type === "light_card" || type === "vacuum_card" || type === "title_card" || type === "pill_card" ? layout : [
            ...layout,
            newLayoutItem
        ];
    ...
    var _editForm_humidity_entity_id, _editForm_consumption_entity_id, _editForm_script_ids, _editForm_script_ids1, _editForm_cleaned_area_entity_id, _editForm_size, _editForm_conditions, _editForm_conditions1;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$app$2d$shell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AppShell"], {
        activeTab: "/dashboards",
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: widgets.filter((w)=>w.type !== "media_card" && w.type !== "climate_card" && w.type !== "climate_card_2" && w.type !== "light_card" && w.type !== "solar_card" && w.type !== "weather_card" && w.type !== "vacuum_card" && w.type !== "title_card" && w.type !== "pill_card").map((w)=>{
                                    ...
                                    children: [
                                        editingWidget.type === "title_card" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                editingWidget.entity_id != null && editingWidget.type !== "title_card" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                            className: "mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                            ...
                                                            className: "w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder-gray-500 dark:border-white/10 dark:bg-white/5 dark:text-gray-200 dark:placeholder-gray-500",
                                                            children: (()=>{
                                                                const options = editingWidget.type === "pill_card" ? entities.filter((e)=>PILL_CARD_DOMAINS.some((d)=>e.entity_id.startsWith(d + "."))) : entities.filter((e)=>{
                                                ...
                                                (editingWidget.type === "climate_card_2" || editingWidget.type === "climate_card") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                            className: "mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            type: "button",
                                                            onClick: ()=>{
                                                                var _editForm_script_ids, _editForm_script_names, _editForm_conditions, _editForm_conditions1;
                                                                const updates = {
...
_s1(DashboardEditPage, "mMkAcHgmD14XBW//pws/bcvuEac=", false, function() {
    return [
...
//# sourceMappingURL=src_f9d0119b._.js.map