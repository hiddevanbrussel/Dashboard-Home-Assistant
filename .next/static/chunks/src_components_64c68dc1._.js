...
;
;
const STORAGE_KEY = "dashboard.floatingStatPillCardPosition";
const DEFAULT_OFFSET = 24;
...
function FloatingStatPillCard(param) {
    let { title, entity_id, label, icon, color = "amber", size = "md", editMode = false, onRemove, onEdit, onEnterEditMode } = param;
    _s();
    const [position, setPosition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
...
_s(FloatingStatPillCard, "hZUTno5j6YWKcC4ejyK1txz749c=");
...
//# sourceMappingURL=src_components_64c68dc1._.js.map