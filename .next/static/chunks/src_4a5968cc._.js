...
function AppShell(param) {
    let { children, activeTab = "/dashboards", showSidebar = true, showFloatingToolbar = false, welcomeBarAction, headerEndAction, temperatureEntityId, className } = param;
...
function MediaCardWidget(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex w-full flex-col overflow-hidden rounded-2xl bg-gray-900/95 dark:bg-black/80 text-white shadow-lg", size === "sm" && "text-sm", size === "md" && "text-base", size === "lg" && "text-lg", className),
        children: [
...
function DashboardEditPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardEditPage.useEffect": ()=>{
            if (editingWidget) {
                var _editingWidget_title, _editingWidget_entity_id;
                setEditForm({
    ...
    const onLayoutChange = (newLayout)=>{
        setLayout((prev)=>{
            const mediaItems = prev.filter((item)=>{
                var _widgets_find;
                return ((_widgets_find = widgets.find((w)=>w.id === item.i)) === null || _widgets_find === void 0 ? void 0 : _widgets_find.type) === "media_card";
            });
            return [
                ...newLayout,
                ...mediaItems
...
_s1(DashboardEditPage, "0JezgFgc06lsmrZ0f8kqfZJWZmY=", false, function() {
    return [
...
//# sourceMappingURL=src_4a5968cc._.js.map