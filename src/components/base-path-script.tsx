...
export function BasePathScript() {
  ...
  // Built as a plain string (not a nested template regex) to avoid escape bugs.
  const code = [
    "(function(){",
    ...
    "return url;",
    "}",
    "var cssUrlRe=/url\\(\\s*(['\"]?)(\\/(?!\\/)[^) '\"]*)\\1\\s*\\)/g;",
    "function rewriteCssUrls(v){",
    "if(typeof v!=='string'||v.indexOf('url(')<0)return v;",
    "return v.replace(cssUrlRe,function(_m,q,path){return 'url('+q+prefix(path)+q+')';});",
    "}",
    ...
    "configurable:true,enumerable:posterDesc.enumerable,get:posterDesc.get,",
    ...
    "var s=el.getAttribute('src');var p=prefix(s);",
    "if(p!==s)origSetAttribute.call(el,'src',p);",
    "}",
    "if(el.hasAttribute('poster')){",
    "var po=el.getAttribute('poster');var pp=prefix(po);",
    "if(pp!==po)origSetAttribute.call(el,'poster',pp);",
    "}",
    "if(el.hasAttribute('style')){",
    "var st=el.getAttribute('style');var ns=rewriteCssUrls(st);",
