...
import { TimerCardWidget } from "./timer-card-widget";

const STORAGE_KEY_PREFIX = "dashboard.floatingTimerCard.";
...
function defaultPosition(): Position {
  ...
  return { left: window.innerWidth / 2 - CARD_WIDTH / 2, bottom: window.innerHeight / 2 - 120 };
}
...
export function FloatingTimerCard({
  ...
  return (
    ...
    >
      <TimerCardWidget title={widget.title} onMoreClick={editMode ? onEdit : undefined} />
    </div>
  );
}
