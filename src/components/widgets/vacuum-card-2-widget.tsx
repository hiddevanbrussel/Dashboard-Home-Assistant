...
export function VacuumCard2Widget({
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-col overflow-hidden rounded-2xl bg-white text-gray-900 shadow-[0_18px_50px_rgba(15,23,42,0.12)] dark:bg-zinc-950 dark:text-white dark:shadow-[0_18px_50px_rgba(0,0,0,0.55)]",
        size === "sm" && "text-sm",
        size === "lg" && "text-lg",
