...
export function FloatingAlarmCard({
  ...
  return (
    <div
      className={cn(
        "card-plot-in fixed z-30 shadow-xl rounded-2xl overflow-hidden bg-white/90 dark:bg-black/50 backdrop-blur-2xl border border-gray-200/80 dark:border-white/10",
