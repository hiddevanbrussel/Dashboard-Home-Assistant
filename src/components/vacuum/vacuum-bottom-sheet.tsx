  ...
  return createPortal(
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 flex justify-center p-3 sm:p-5">
        <div className="animate-music-bar-in pointer-events-auto flex w-full max-w-[360px] max-h-[min(88dvh,740px)] flex-col overflow-hidden rounded-[1.75rem] bg-[#F4F6FA] shadow-[0_-18px_60px_rgba(15,23,42,0.28)] dark:bg-zinc-900 dark:shadow-[0_-18px_60px_rgba(0,0,0,0.55)]">
